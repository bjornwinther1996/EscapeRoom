...
public class GameManager : MonoBehaviour
{
    ...
    {
        if(syncedGameVariables._backupInt > 3) // was Avatars.Count // make < 2 when final test, to make sure computer is connected to log telemetry data. // was: syncedGameVariables._backupInt == 2
        {
            return true;
        }
        else
